...
const getBook = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const authorBook = yield authorModels_1.default.findById(author).populate('books');
        // const bookId = authorBook?.books.map((elem: { _id: any; }) => {
...
const getMyBooks = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const author = yield authorModels_1.default.findById(id);
        const bookId = author === null || author === void 0 ? void 0 : author.books;
        const myBooks = [];
        const findBook = yield bookModels_1.default.findById(bookId);
        myBooks.push(findBook);
        return res.status(200).render('getMyBooks', { title: 'My Books', token, myBooks });
    }
    catch (error) {
        console.log(error);
        res.status(400);
...
const createBook = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const author = yield authorModels_1.default.findById(id);
    const book = yield bookModels_1.default.create(req.body);
...
const updateBook = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedBook = yield bookModels_1.default.findByIdAndUpdate(id, req.body, {
        new: true,
    });
    const books = yield bookModels_1.default.find();
    return res.status(201).render('dashboard', { title: 'Books', books, token });
});
