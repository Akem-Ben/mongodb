...
router.post("/create", jwt_authorization_1.protect, bookControllers_1.createBook);
router.post("/update/:id", jwt_authorization_1.protect, bookControllers_1.updateBook);
